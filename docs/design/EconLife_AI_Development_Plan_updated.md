...
*Companion document to GDD v1.7, Feature Tier List, and Technical Design Document v23*
...
├── docs/
│   ├── design/
│   │   ├── GDD_v12.md                    # The game design document
...
Design questions: Read GDD v1.7 in docs/design/
...
*EconLife AI-Coder Development Plan — Companion to GDD v1.7 — Living Document*
