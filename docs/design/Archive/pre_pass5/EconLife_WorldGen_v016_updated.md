...
*Companion document to GDD v1.7, Technical Design v23, World Map & Geography v1.1*
*Version 0.17 — Scope change: promoted to V1 per design decision. H3Index and ProvinceLink now integrated into TDD v23 Province struct.*
...
uint64_t  nation_id;                      // which nation this province belongs to.
                                           ...
                                           // for future EX multi-resolution compatibility. TDD v19 Province
...
*EconLife — Procedural World Generation v0.3*
*Status: Design draft — pending ratification and TDD integration*
