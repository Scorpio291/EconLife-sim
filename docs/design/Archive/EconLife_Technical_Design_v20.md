...
struct Province {
    ...
    bool     has_karst;                  // true = province contains karst terrain (cave systems,
                                          ...
                                          // criminal systems (WorldGen v0.16 §Stage 7).
                                          // Effects:
...
`has_karst: bool` — set by GIS pipeline from WorldGen karst probability layer at world load; static at runtime. WorldGen v0.16 §Stage 7 flagged this as a load-bearing V1 field for criminal smuggling routes and hidden facility concealment. Two downstream effects:
...
*EconLife Technical Design Document v21 — Pass 3 Session 21 Complete — Companion to GDD v1.5*
