...
//   float provincial_business_tax_rate;  // set by scenario file; modifiable by provincial
//   legislation float property_tax_revenue_estimate; // seeded at world gen; placeholder until real
//   estate specced
