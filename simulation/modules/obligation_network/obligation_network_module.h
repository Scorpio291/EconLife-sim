...
class ObligationNetworkModule : public ITickModule {
   public:
    ...
    std::vector<std::string_view> runs_before() const override { return {"trust_updates"}; }
    ...
    static float compute_player_wealth_factor(float visible_net_worth, float wealth_reference_scale,
