...
public:
    ...
    static float apply_actionability_decay(float current_actionability,
    ...
    static bool evaluate_holder_credibility(float public_credibility,
    ...
    static float compute_propagation_confidence(float sharer_confidence,
