    ...
    static float get_modifier(uint8_t conflict_stage) {
        switch (conflict_stage) {
            case 0:
                return 0.0f;  // none
            case 1:
                return 0.2f;  // economic
            case 2:
                return 0.2f;  // intelligence_harassment
            case 3:
                return 0.5f;  // property_violence
            case 4:
                return 0.8f;  // personnel_violence
            case 5:
                return 1.5f;  // open_warfare
            case 6:
                return 0.0f;  // resolution
            default:
                return 0.0f;
        }
    }
