...
void EraCatalog::load_builtin_default() {
    ...
    static const Row rows[] = {
        {1, "neolithic", "Neolithic", -10000, "subsistence", false, true, 92.0f, 0.0f},
        {2, "bronze_age", "Bronze Age", -3300, "barter", false, true, 321.0f, 0.0f},
        {3, "iron_age", "Iron Age", -1200, "coinage", false, true, 1024.0f, 0.0f},
        {4, "classical", "Classical", -550, "money", false, true, 3214.0f, 0.0f},
        {5, "medieval", "Medieval", 500, "feudal", false, true, 10700.0f, 0.0f},
        {6, "early_modern", "Early Modern", 1450, "mercantile", false, true, 34196.0f, 0.0f},
        {7, "industrial", "Industrial", 1750, "industrial", false, true, 106189.0f, 0.0f},
