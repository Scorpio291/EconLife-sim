...
void EraCatalog::load_builtin_default() {
    ...
    static const Row rows[] = {
        ...
        {4, "classical", "Classical", -550, "money", false, true, 52000.0f},
        {5, "medieval", "Medieval", 500, "feudal", false, true, 280000.0f},
        {6, "early_modern", "Early Modern", 1450, "mercantile", false, true, 950000.0f},
        {7, "industrial", "Industrial", 1750, "industrial", false, true, 1900000.0f},
