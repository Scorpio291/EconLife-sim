...
PackageConfig load_package_config(const std::string& config_dir) {
    ...
    // -----------------------------------------------------------------
    {
        ...
        cfg.price_model.equilibrium_convergence_speed = pm.value("equilibrium_convergence_speed", cfg.price_model.equilibrium_convergence_speed);
        cfg.price_model.price_floor_multiplier        = pm.value("price_floor_multiplier",        cfg.price_model.price_floor_multiplier);
        cfg.price_model.price_ceiling_multiplier      = pm.value("price_ceiling_multiplier",      cfg.price_model.price_ceiling_multiplier);
        cfg.price_model.import_ceiling_premium        = pm.value("import_ceiling_premium",        cfg.price_model.import_ceiling_premium);
        cfg.price_model.export_floor_discount         = pm.value("export_floor_discount",         cfg.price_model.export_floor_discount);
        ...
        cfg.labor_market.unemployment_equilibrium_rate = lm.value("unemployment_equilibrium_rate",   cfg.labor_market.unemployment_equilibrium_rate);
        ...
        cfg.trade.transport_cost_per_km_per_tonne   = tr.value("transport_cost_per_km_per_tonne",   cfg.trade.transport_cost_per_km_per_tonne);
        cfg.trade.transit_delay_base_ticks          = tr.value("transit_delay_base_ticks",          cfg.trade.transit_delay_base_ticks);
    }
    ...
    // -----------------------------------------------------------------
    {
        ...
        cfg.npc_behavior.motivation_power_influence     = mw.value("power_influence",     cfg.npc_behavior.motivation_power_influence);
        cfg.npc_behavior.motivation_ideology            = mw.value("ideology",            cfg.npc_behavior.motivation_ideology);
        cfg.npc_behavior.motivation_loyalty             = mw.value("loyalty",             cfg.npc_behavior.motivation_loyalty);
        cfg.npc_behavior.motivation_self_preservation   = mw.value("self_preservation",   cfg.npc_behavior.motivation_self_preservation);
        cfg.npc_behavior.memory_decay_rate              = nb.value("memory_decay_rate_per_tick", cfg.npc_behavior.memory_decay_rate);
    ...
    // -----------------------------------------------------------------
    {
        ...
        cfg.production.tech_tier_output_bonus          = j.value("tech_tier_output_bonus_per_tier",      cfg.production.tech_tier_output_bonus);
        cfg.production.tech_tier_cost_reduction        = j.value("tech_tier_cost_reduction_per_tier",    cfg.production.tech_tier_cost_reduction);
        cfg.production.tech_quality_ceiling_base       = j.value("tech_quality_ceiling_base",            cfg.production.tech_quality_ceiling_base);
        cfg.production.tech_quality_ceiling_step       = j.value("tech_quality_ceiling_step",            cfg.production.tech_quality_ceiling_step);
        cfg.production.worker_productivity_diminishing = j.value("worker_productivity_diminishing_factor", cfg.production.worker_productivity_diminishing);
        cfg.production.minimum_input_fraction          = j.value("minimum_input_fraction_to_produce",    cfg.production.minimum_input_fraction);
    }
    ...
    // -----------------------------------------------------------------
    {
        ...
        cfg.rnd.maturation_rate_coeff             = j.value("maturation_rate_coeff",             cfg.rnd.maturation_rate_coeff);
        cfg.rnd.maturation_difficulty_per_level   = j.value("maturation_difficulty_per_level",   cfg.rnd.maturation_difficulty_per_level);
        cfg.rnd.base_research_success_rate        = j.value("base_research_success_rate",        cfg.rnd.base_research_success_rate);
        cfg.rnd.domain_knowledge_bonus_coeff      = j.value("domain_knowledge_bonus_coeff",      cfg.rnd.domain_knowledge_bonus_coeff);
        cfg.rnd.unexpected_discovery_probability  = j.value("unexpected_discovery_probability",  cfg.rnd.unexpected_discovery_probability);
        cfg.rnd.patent_preemption_check_rate      = j.value("patent_preemption_check_rate",      cfg.rnd.patent_preemption_check_rate);
        cfg.rnd.knowledge_decay_rate              = j.value("knowledge_decay_rate",              cfg.rnd.knowledge_decay_rate);
        cfg.rnd.era_transition_threshold          = j.value("era_transition_threshold",          cfg.rnd.era_transition_threshold);
        cfg.rnd.patent_duration_ticks             = j.value("patent_duration_ticks",             cfg.rnd.patent_duration_ticks);
    }
