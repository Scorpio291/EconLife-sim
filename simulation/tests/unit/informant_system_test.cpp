...
TEST_CASE("Informant: flip probability full formula", "[informant_system][tier9]") {
    ...
    // clamped to MAX 0.20
    float prob = InformantSystemModule::compute_flip_probability(0.10f, 0.5f, 0.5f, 0, 0, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
    REQUIRE_THAT(prob, WithinAbs(0.20f, 0.01f));
}

TEST_CASE("Informant: flip probability capped at MAX", "[informant_system][tier9]") {
    float prob = InformantSystemModule::compute_flip_probability(0.10f, 0.0f, 0.0f, 0, 0, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
    // 0.10 + 0.30 + 0.25 = 0.65, capped to 0.20
    REQUIRE_THAT(prob, WithinAbs(0.20f, 0.01f));
}

TEST_CASE("Informant: mutual incrimination reduces flip", "[informant_system][tier9]") {
    float without = InformantSystemModule::compute_flip_probability(0.10f, 0.5f, 0.5f, 0, 0, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
    float with_mutual = InformantSystemModule::compute_flip_probability(0.10f, 0.5f, 0.5f, 2, 0, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
...
TEST_CASE("Informant: compartmentalization reduces flip", "[informant_system][tier9]") {
    ...
    float without = InformantSystemModule::compute_flip_probability(0.05f, 0.9f, 0.9f, 0, 0, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
    float with_compart = InformantSystemModule::compute_flip_probability(0.05f, 0.9f, 0.9f, 0, 3, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
...
TEST_CASE("Informant: high trust suppresses flip", "[informant_system][tier9]") {
    ...
    float low_trust = InformantSystemModule::compute_flip_probability(0.02f, 0.9f, 0.5f, 0, 0, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
    float high_trust = InformantSystemModule::compute_flip_probability(0.02f, 0.9f, 0.9f, 0, 0, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
    REQUIRE(high_trust < low_trust);
}

TEST_CASE("Informant: flip probability non-negative", "[informant_system][tier9]") {
    // Extreme suppression
    float prob = InformantSystemModule::compute_flip_probability(0.10f, 1.0f, 1.0f, 5, 5, 0.20f, 0.30f, 0.25f, 0.08f, 0.05f);
    REQUIRE(prob >= 0.0f);
}
